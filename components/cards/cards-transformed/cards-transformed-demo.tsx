...
import { TOKYO_IMAGES } from "@/components/heros/hero-gallery-scale/hero-gallery-scale-demo"
...
export const CardsTransformedDemoDark = () => {
  return (
          ...
          <CardsContainer className="mx-auto size-full h-[450px] w-[350px]">
            {TESTIMONIALS.map((testimonial, index) => (
              <CardTransformed
                ...
                key={testimonial.id}
                index={index + 2}
                // className="flex size-full flex-col items-center justify-center gap-6 rounded-2xl border border-stone-700/50 bg-background/80 p-6 backdrop-blur-md transition-all hover:backdrop-blur-lg md:gap-8"
                role="article"
...
export const CardsTransformedDemoLight = () => {
  return (
    <section className="bg-accent px-8 py-12">
      <div>
        <h3 className="text-center text-4xl font-semibold">Testimonials</h3>
...
export const CardsTransformedServices = () => {
  return (
    <section className="bg-accent px-8 py-12">
      <div>
...
export const CardsTransformedPokemon = () => {
  return (
